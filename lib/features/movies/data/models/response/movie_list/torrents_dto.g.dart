...
part of 'torrents_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TorrentsDto _$TorrentsDtoFromJson(Map<String, dynamic> json) => TorrentsDto(
...
Map<String, dynamic> _$TorrentsDtoToJson(TorrentsDto instance) =>
    <String, dynamic>{
      'url': instance.url,
      'hash': instance.hash,
