              ...
              SliverAppBar(
                          ...
                          children: [
                            Column(children: [
                              state.user.photoUrl != null
                                  ? Image.asset(
                                state.user.photoUrl!, width: 118.w,)
                                  : Image.asset(PathImage.g1, width: 118.w,),
                              SizedBox(height: 12.h),
                              SizedBox(child: Text(state.user.name ?? 'User',
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    _statWidget(
                                        '${state.watchlistCount}', 'Wish List'),
                                    SizedBox(width: 24.w),
                                    _statWidget(
                                        '${state.historyCount}', 'History'),
                                  ],
                                ),
                              ],
                            ),
                            ...
                            Expanded(
                              ...
                              child: CustomElevatedButton(
                                ...
                                customWidgetWithIcon: Row(
                                  ...
                                  children: [
                                    Text(
                                      'Exit', style: TextApp.regular20White,),
                ...
                bottom: TabBar(
                  ...
                  tabs: [
                    Tab(
                      icon: Icon(
                        Icons.format_list_bulleted_rounded, size: 40.w,),
                      text: 'Watch List',
                      height: 100,
                    ),
                    Tab(
